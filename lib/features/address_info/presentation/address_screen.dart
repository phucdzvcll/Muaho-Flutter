...
import 'package:muaho/features/create_address/presentation/create_location_screen.dart';
...
class AddressScreen extends StatelessWidget {
  ...
  Widget _handleBuilder(AddressState state, BuildContext context) {
    if (state is GetListAddressSuccess) {
      return state.addressInfoEntities.isNotEmpty
          ? ListView.builder(
              padding: const EdgeInsets.only(bottom: 76),
              itemBuilder: (context, index) {
                return _addressBuilder(
                    state.addressInfoEntities[index], context);
              },
