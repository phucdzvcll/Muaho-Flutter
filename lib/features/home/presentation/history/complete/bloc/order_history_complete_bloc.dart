...
import 'package:muaho/features/home/domain/use_case/history/get_order_history_delivery_use_case.dart';
import 'package:muaho/features/home/presentation/history/models/order_history_complete_model.dart';
...
class OrderHistoryCompleteBloc
  ...
  Future _handleGetOrderComplete(
    ...
    if (result.isSuccess) {
      OrderHistoryCompleteSuccess orderHistoryCompleteSuccess =
          OrderHistoryCompleteSuccess(
