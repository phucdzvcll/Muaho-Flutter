...
import 'package:muaho/features/components/adjustment_auantity_Button.dart';
import 'package:muaho/features/components/app_bar_component.dart';
import 'package:muaho/features/components/cart_over_view.dart';
        ...
        return Container(
          ...
          child: state is CartUpdatedState
              ...
              : Column(
                  ...
                  children: [
                    Lottie.asset(Assets.json.pageEmpty),
                    Text(
                      LocaleKeys.cart_noItemMsg.translate(),
                    ),
                  ],
                ),
        );
      ...
      child: Row(
        ...
        children: [
          ...
          Padding(
            ...
            child: Text(productEntity.quantity.toString(),
