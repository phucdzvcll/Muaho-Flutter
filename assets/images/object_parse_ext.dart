...
extension JsonParseExtension on Map<String, dynamic> {
  ...
  List<String>? parseListString(String key, {required String defaultValue}) {
    ...
    if (object != null && object is List) {
      return object.map((value) => ObjectParseUtil.parseString(value) ?? defaultValue).toList();
    }
  ...
  List<int>? parseListInt(String key, {required int defaultValue}) {
    dynamic object = this[key];
    if (object != null && object is List) {
      return object.map((value) => ObjectParseUtil.parseInt(value) ?? defaultValue).toList();
    }
  ...
  List<double>? parseListDouble(String key, {required double defaultValue}) {
    dynamic object = this[key];
    if (object != null && object is List) {
      return object.map((value) => ObjectParseUtil.parseDouble(value) ?? defaultValue).toList();
    }
  ...
  List<bool>? parseListBool(String key, {required bool defaultValue}) {
    dynamic object = this[key];
    if (object != null && object is List) {
      return object.map((value) => ObjectParseUtil.parseBool(value) ?? defaultValue).toList();
    }

    return null;
  }

  List<T>? parseListObject<T>(String key, T Function(Map<String, dynamic> item) itemFromJson) {
    dynamic object = this[key];
    if (object != null && object is List) {
  ...
  T? parseObject<T>(String key, T Function(Map<String, dynamic> data) fromJson) {
    dynamic object = this[key];
    if (object != null) {
